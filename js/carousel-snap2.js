...
( function( $ ) {
	var CarouselSnap = function( element, options ) {
		...
		var appendPrevNextButtons = function() {
			container.after( '<div class="'+settings.prevClass+'" id="' + settings.prevID + '">Previous</div><div class="'+settings.nextClass+'" id="' + settings.nextID + '">Next</div>' );
		};
	...
	$.fn.carouselSnap.defaults = {
		...
		prevClass : 'prevNext prevLink',
		nextClass : 'prevNext nextLink',
		elementsToMove: 3,
		time: 1000,
		loadPerFetch: 10,
